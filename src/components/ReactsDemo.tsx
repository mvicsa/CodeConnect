...
// Example data structure matching your database
const examplePost = {
  id: "1",
  reactions: {
    like: 12,
...
export default function ReactsDemo() {
  ...
  return (
    <div className="space-y-6 p-6">
      <h1 className="text-2xl font-bold">Enhanced Reacts Component Demo</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>No Reactions Yet</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
